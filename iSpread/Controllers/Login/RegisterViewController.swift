...
class RegisterViewController: UIViewController {
        ...
        private let imageView: UIImageView = {
            ...
            imageView.image = UIImage(systemName: "person.circle") // use SF symbols
        ...
        private let registerButton: UIButton = {
            ...
            button.backgroundColor = .systemGreen //color change?
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        let actionSheet = UIAlertController(title: "Profile Picture",message: "Hwo would you like to select a picture?",preferredStyle: .actionSheet)
